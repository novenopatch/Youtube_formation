"""Ce fichier définit des fonctions utiles pour le programme pendu. On utilise les données du programme contenues dans donnees.py""" 
import os 
import pickle 
...
def recup_nom_utilisateur():    
    ...
    nom_utilisateur = input("Tapez votre nom: ")    # On met la première lettre en majuscule et les autres en minuscules    
...
def recup_lettre(): 
	...
	Si la chaîne récupérée n'est pas une lettre, on appelle récursivement la fonction jusqu'à obtenir une lettre"""    
	...
	if len(lettre)>1 or not lettre.isalpha():
		...
		return lettre # Fonctions du jeu de pendu 
def choisir_mot():    
